...
const FiveDayInfo = () => {
   ...
   return (
      <div>
         <p className='flex_center'>Weather forecast for <span className="weather-data_city">{city}</span> as of <span className='weather-data_city'>{time.slice(5, -3)}</span></p>
         ...
         <div className='flex'>
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp.toFixed(1)}</span>°C</p>
            ...
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp1.toFixed(1)}</span>°C</p>
            ...
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp2.toFixed(1)}</span>°C</p>
            ...
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp3.toFixed(1)}</span>°C</p>
            ...
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp4.toFixed(1)}</span>°C</p>
            ...
            <div className='flex_part'>
               ...
               <p><span className='flex_misura'>Temperature: </span><span className='flex_num'>{temp5.toFixed(1)}</span>°C</p>
